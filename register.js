const apiURL= ('https://localhost:7292/api/Cuentas/Registrar');
...
registerForm.addEventListener('submit', (event) => {
    ...
    const cuenta = {
        ...
        apellidoPaterno: document.querySelector('#secondName').value,
        apellidoMaterno: document.querySelector('#thirdName').value,
    ...
    fetch(apiURL, {
        ...
        if (localStorage.getItem("token") != null) {
            setTimeout(function () { window.location.href = "./userLoginForm.html"; }, 2000);
        } else {
